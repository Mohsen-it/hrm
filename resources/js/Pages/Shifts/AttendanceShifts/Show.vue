  ...
  <AppLayout>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
      <Card class="lg:col-span-1">
        ...
        <dl class="space-y-3">
          <div>
            <dt class="text-sm text-mistral-steel">{{ t('attendance.fields.alias') }}</dt>
            <dd class="font-medium">{{ shift.alias }}</dd>
          </div>
          <div>
            <dt class="text-sm text-mistral-steel">{{ t('attendance.fields.cycle_unit') }}</dt>
            <dd class="font-medium">{{ formatCycleUnit(shift.cycle_unit) }}</dd>
          </div>
          <div>
            <dt class="text-sm text-mistral-steel">{{ t('attendance.fields.shift_cycle') }}</dt>
            <dd class="font-medium">{{ shift.shift_cycle }}</dd>
          </div>
          <div>
            <dt class="text-sm text-mistral-steel">{{ t('attendance.fields.work_weekend') }}</dt>
            <dd>
      ...
      <Card class="lg:col-span-2">
        ...
        <DataTable
          ...
          storage-key="attendance-shift-details"
          enable-search="false"
