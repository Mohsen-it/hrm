        ...
        <form class="card p-6" @submit.prevent="submit">
            ...
            <div class="mt-4 flex items-center gap-4">
                <div class="flex items-center gap-2">
                    <input
                        id="supports_fingerprint"
                        v-model="form.supports_fingerprint"
                        type="checkbox"
                        class="w-4 h-4"
                    />
                    <label for="supports_fingerprint" class="text-[14px] text-[var(--color-ink)]">
                ...
                <div class="flex items-center gap-2">
                    <input
                        ...
                        class="w-4 h-4"
                    />
                    <label for="supports_face" class="text-[14px] text-[var(--color-ink)]">
                ...
                <div class="flex items-center gap-2">
                    <input
                        ...
                        class="w-4 h-4"
                    />
                    <label for="is_active" class="text-[14px] text-[var(--color-ink)]">
                        {{ t('common.active') }}
                    </label>
                </div>
            </div>
