                ...
                <Transition
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="min-h-0 flex-1 overflow-y-auto overscroll-contain p-6 max-sm:p-5">
                                <slot />
                            </div>
                            <div v-if="$slots.footer" class="flex shrink-0 items-center justify-end gap-2 border-t border-mistral-hairline-soft bg-mistral-surface/30 px-6 py-4 max-sm:px-5 max-sm:pb-[calc(1rem+env(safe-area-inset-bottom))]">
                                <slot name="footer" />
                            </div>
                        </Card>
                </Transition>
