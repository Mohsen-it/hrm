    ...
    <AppLayout :title="t('companies.view_company')">
        ...
        >
            <template #actions>
                ...
                <Button variant="primary" icon="fas fa-pen" :href="route('companies.edit', company.id)">
                    {{ t('common.edit') }}
                </Button>
            </template>
        </PageHeader>
        ...
        <Card variant="base" padding="none">
            <div class="p-5 sm:p-6">
                ...
                <div class="flex items-center gap-4 mb-6 pb-6 border-b border-mistral-hairline-soft">
                    <div
                        class="w-16 h-16 rounded-xl bg-mistral-surface flex items-center justify-center overflow-hidden border border-mistral-hairline-soft"
                    >
                        <img
                        ...
                        />
                        <i v-else class="fas fa-building text-[28px] text-mistral-stone"></i>
                    </div>
                    <div>
