...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'hire_date', 'termination_date', 'attendance_exemption_type', 'attendance_exemption_from', 'attendance_exemption_to', 'employment_type',
    ...
    protected function casts(): array
    {
        return [
            ...
            'attendance_exemption_from' => 'date',
            'attendance_exemption_to' => 'date',
            'password' => 'hashed',
