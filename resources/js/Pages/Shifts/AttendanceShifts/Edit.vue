<template>
  <AppLayout>
    <PageHeader :title="t('actions.edit') + ' ' + t('attendance.attendance_shift')">
...
const form = useForm({
  alias: props.shift.alias,
  cycle_unit: props.shift.cycle_unit,
  shift_cycle: props.shift.shift_cycle,
  frequency: props.shift.frequency,
  work_weekend: props.shift.work_weekend,
  work_day_off: props.shift.work_day_off,
  details: (props.shift.details || []).map(d => ({
    day_index: d.day_index,
    in_time: d.in_time,
    out_time: d.out_time,
    time_interval_id: d.time_interval_id,
  })),
})
