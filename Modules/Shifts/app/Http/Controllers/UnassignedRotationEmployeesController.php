...
use Modules\Shifts\Repositories\UnassignedRotationEmployeeRepository;
use Modules\Subordinations\Services\SubordinationService;
use Modules\Users\Http\Resources\UserIndexResource;

/**
 * UnassignedRotationEmployeesController — shows active employees who are
 * not assigned to any rotation (open assignment with no end date).
 */
class UnassignedRotationEmployeesController extends Controller
{
    use ExcelExportable;

    public function __construct(
        private UnassignedRotationEmployeeRepository $repository,
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Shifts/Rotations/UnassignedEmployees', [
            'filters' => fn () => $filters,
    ...
    public function export(Request $request)
    {
        ...
        return $this->quickExcelExport('الموظفون غير المسندين لأي دورية', $headers, $employees->getCollection(), $columns, 'unassigned-rotation-employees');
    }
