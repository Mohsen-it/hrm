...
class UserpicIngestionJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(
        UserpicIngestionService $ingestionService,
        ...
        $auditLogger->log('userpic_job_completed', [
        ...
        Log::channel('biodata')->info('USERPIC_JOB_COMPLETED', [
            'correlation_id' => $this->correlationId,
            'device_serial' => $this->deviceSerial,
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        $auditLogger->log('userpic_job_failed', [
            'correlation_id' => $this->correlationId,
            'device_serial' => $this->deviceSerial,
            'status' => 'failed',
        ...
        Log::channel('biodata')->error('USERPIC_JOB_FAILED', [
            'correlation_id' => $this->correlationId,
            'device_serial' => $this->deviceSerial,
