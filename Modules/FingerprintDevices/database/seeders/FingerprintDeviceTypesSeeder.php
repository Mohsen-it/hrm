...
class FingerprintDeviceTypesSeeder extends Seeder
{
    ...
    protected array $defaults = [
        ...
        [
            ...
            'max_users' => 5000,
            'description' => 'Mini access control terminal with face + fingerprint + card.',
            'is_active' => true,
        ],
        [
            'name' => 'DS-K1T672MFW',
            ...
            'max_fingerprints' => 3000,
            'max_users' => 10000,
            'description' => '4.3" touchscreen terminal with face recognition and fingerprint.',
            'is_active' => true,
        ],
        [
            'name' => 'DS-K1T606MFW',
            ...
            'max_users' => 5000,
            'description' => 'Entry-level face recognition terminal with fingerprint support.',
            'is_active' => true,
        ],
    ];
