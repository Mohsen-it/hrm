...
const form = reactive({
    ...
    max_days_per_request: props.type.max_days_per_request ?? 0,
    max_carry_days: props.type.max_carry_days ?? 0,
...
usePageTitle(t('vacations.edit_type'));
</script>
        ...
        <form class="space-y-6" @submit.prevent="submit">
            ...
            <FormSection :title="t('vacations.settings')" icon="fas fa-cog" :collapsible="true" :default-open="true">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormInput v-model="form.max_carry_days" :label="t('vacations.max_carry_days')" name="max_carry_days" type="number" :error="errorFor('max_carry_days')" />
