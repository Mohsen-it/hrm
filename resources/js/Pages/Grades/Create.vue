...
import { PageHeader, Button, Card, FormInput, FormSelect, FormTextarea, FormSection, FormActions, ErrorSummary } from '@/Components/ui';
...
function submit() {
    ...
    router.post(route('grades.store'), payload, {
        preserveScroll: true,
...
<template>
    <AppLayout :title="t('grades.add_new')">
        <PageHeader
            :title="t('grades.add_new')"
            :description="t('grades.create_description')"
        >
            <template #actions>
                <Button variant="secondary" icon="fas fa-arrow-right rtl-flip" :href="route('grades.index')">
                    {{ t('common.back') }}
                </Button>
            </template>
        </PageHeader>
