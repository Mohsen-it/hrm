    ...
    <AppLayout :title="t('attendance.session')">
        ...
        >
            ...
            <template #actions>
                ...
                <Link :href="route('attendance.sessions.index')" class="btn btn-ghost">
                ...
                <Button variant="primary" icon="fas fa-edit" :href="route('attendance.sessions.edit', session.id)">{{ t('attendance.actions.edit') }}</Button>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div v-if="session.raw_log" class="flex items-center justify-between">
                        ...
                        <Link
                            ...
                            class="text-[12px] text-mistral-info font-semibold"
