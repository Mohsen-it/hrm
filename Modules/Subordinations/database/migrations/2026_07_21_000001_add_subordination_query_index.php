...
/**
 * T011 — Add status+sort_order index to subordinations.
 *
 * Serves the dropdown listing (active + ordered by sort_order).
 */
return new class extends Migration
{
    ...
    {
        try {
            Schema::table('subordinations', function (Blueprint $table): void {
                $table->index(['status', 'sort_order'], 'idx_subordinations_status_order');
            });
    ...
    public function down(): void
    {
        try {
            Schema::table('subordinations', function (Blueprint $table): void {
                $table->dropIndex('idx_subordinations_status_order');
            });
        } catch (QueryException|PDOException $e) {
