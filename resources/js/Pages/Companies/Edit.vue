...
<template>
    ...
    <AppLayout :title="t('companies.edit_company')">
        ...
        <Card variant="base" padding="md" as="form" @submit.prevent="submit">
            ...
            <div v-if="company.logo_url" class="mb-4 flex items-center gap-3">
                ...
                <img
                    ...
                    class="w-16 h-16 rounded-md object-cover border border-mistral-hairline-soft"
            ...
            <div class="mt-6 flex items-center justify-start gap-2">
                ...
                <Button variant="secondary" :href="route('companies.index')">{{ t('common.cancel') }}</Button>
