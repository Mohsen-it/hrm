    ...
    <AppLayout :title="t('users.view_user')">
        ...
        <Card variant="base" padding="none" class="mb-4">
            <div class="p-5 sm:p-6">
                <div class="flex items-center gap-4 pb-6 border-b border-mistral-hairline-soft">
                    <div class="w-20 h-20 rounded-full bg-mistral-surface flex items-center justify-center overflow-hidden border border-mistral-hairline-soft">
                        <img
        ...
        <Card variant="base" padding="none" class="mb-4">
            <div class="p-5 sm:p-6">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3">
                    <div v-for="(field, idx) in personalFields" :key="idx" class="flex flex-col text-end">
        ...
        <Card variant="base" padding="none" class="mb-4">
            <div class="p-5 sm:p-6">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3">
                    <div v-for="(field, idx) in employmentFields" :key="idx" class="flex flex-col text-end">
                        <dt class="text-[12px] font-semibold text-mistral-stone uppercase tracking-wider">
                            {{ field.label }}
                        </dt>
                        <dd class="text-[14px] text-mistral-ink mt-1 break-words">
        ...
        <Card variant="base" padding="none" class="mb-4">
            <div class="p-5 sm:p-6">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3">
                    <div v-for="(field, idx) in orgFields" :key="idx" class="flex flex-col text-end">
                        <dt class="text-[12px] font-semibold text-mistral-stone uppercase tracking-wider">
                            {{ field.label }}
                        </dt>
                        <dd class="text-[14px] text-mistral-ink mt-1 break-words">
        ...
        <Card variant="base" padding="none" class="mb-4">
            <div class="p-5 sm:p-6">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3">
                    <div v-for="(field, idx) in contactFields" :key="idx" class="flex flex-col text-end">
                        <dt class="text-[12px] font-semibold text-mistral-stone uppercase tracking-wider">
                            {{ field.label }}
                        </dt>
                        <dd class="text-[14px] text-mistral-ink mt-1 break-words">
        ...
        <Card variant="base" padding="none" class="mb-4">
            <div class="p-5 sm:p-6">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3">
                    <div v-for="(field, idx) in emergencyFields" :key="idx" class="flex flex-col text-end">
                        <dt class="text-[12px] font-semibold text-mistral-stone uppercase tracking-wider">
                            {{ field.label }}
                        </dt>
                        <dd class="text-[14px] text-mistral-ink mt-1 break-words">
        ...
        <Card variant="base" padding="none">
            <div class="p-5 sm:p-6">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3">
                    <div v-for="(field, idx) in bankingFields" :key="idx" class="flex flex-col text-end">
                        <dt class="text-[12px] font-semibold text-mistral-stone uppercase tracking-wider">
                            {{ field.label }}
                        </dt>
                        <dd class="text-[14px] text-mistral-ink mt-1 break-words">
