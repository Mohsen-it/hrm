...
const variantClasses = computed(() => {
    const map = {
        ...
        info: [
            ...
            'hover:bg-mistral-info/15 hover:text-mistral-info hover:brightness-90',
        ...
        success: [
            ...
            'hover:bg-mistral-success/15 hover:text-mistral-success hover:brightness-90',
        ...
        warning: [
            ...
            'hover:bg-mistral-warning/15 hover:text-mistral-warning hover:brightness-90',
        ...
        danger: [
            ...
            'hover:bg-mistral-danger/15 hover:text-mistral-danger hover:brightness-90',
