...
/**
 * UpdateShiftCategoryRequest — validate the update-shift-category payload.
 */
class UpdateShiftCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'type' => ['sometimes', 'string', Rule::in(['cyclic', 'weekly', 'hours'])],
    ...
    public function routeShiftCategoryId(): int
    {
        return (int) $this->route('shift_category');
    }
}
