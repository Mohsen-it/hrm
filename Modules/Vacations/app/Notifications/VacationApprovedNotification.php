...
/**
 * VacationApprovedNotification — notify the employee that their request
 * was approved.
 */
class VacationApprovedNotification extends Notification
{
    ...
    public function toMail(mixed $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('vacations.notifications.approved_subject'))
            ->greeting(__('vacations.notifications.greeting'))
            ->line(__('vacations.notifications.approved_line_1'))
