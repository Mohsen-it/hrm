    ...
    <AppLayout :title="t('vacations.edit_request')">
        ...
        <PageHeader :title="t('vacations.edit_request')" :description="request.user?.name">
            ...
            <template #actions>
                ...
                <Button variant="secondary" :href="route('vacations.requests.show', request.id)">{{ t('common.back') }}</Button>
        ...
        <Card variant="base" padding="md" as="form" @submit.prevent="submit">
            ...
            <div class="mt-6 flex items-center justify-start gap-2">
                ...
                <Button variant="secondary" :href="route('vacations.requests.show', request.id)">{{ t('common.cancel') }}</Button>
