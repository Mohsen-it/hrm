...
<template>
  <PageHeader title="تسجيل تبرير" description="يُحسب التأخير تلقائياً من وقت الوصول ونافذة الدخول المعتمدة للدورية."><template #actions><Button variant="secondary" :href="route('vacations.justifications.index')">عودة</Button></template></PageHeader>
