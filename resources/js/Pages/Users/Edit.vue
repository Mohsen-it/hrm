...
<template>
    ...
    <AppLayout :title="t('users.edit_user')">
        ...
        <form class="space-y-6" @submit.prevent="submit">
            ...
            <div v-if="user.avatar_url" class="card p-4 flex items-center gap-3">
            ...
            <div class="card p-6">
                ...
                <div>
                    ...
                    <p v-if="errorFor('avatar')" class="text-[11px] text-mistral-danger mt-1">
            ...
            <div class="flex items-center justify-start gap-2">
                ...
                <Button variant="secondary" :href="route('users.index')">{{ t('common.cancel') }}</Button>
